 ...
 */
public class GeneralSlewRateLimiter {
   ...
   */
  public GeneralSlewRateLimiter(double rateLimit, Vector<N2> initialValue) {
   ...
   * @param rateLimit The rate-of-change limit, in units per second.
   */
  public GeneralSlewRateLimiter(double rateLimit) {
